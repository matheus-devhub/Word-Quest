...
- **HTML5** -Used to structure the game's layout and elements.
- **CSS3** - For styling and creating an engaging user interface.
...
1. **Clone the repository:**
   ```sh
   git clone https://github.com/matheus-devhub/Word-Quest.git
   ```
